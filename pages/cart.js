...
import { getCart, removeFromCart, createOrder, supabase } from '../lib/supabase'
import { orderConfirmationEmail } from '../lib/emails'
import { sendEmail } from '../lib/sendEmail'
import { useAuth, useCart } from './_app'
import { useLang } from '../lib/LangContext'
import { Trash2, Plus, Minus, ArrowRight, X, CheckCircle } from 'lucide-react'
              ...
              <div className="px-6 py-6">
                ...
                {step === 2 && !orderDone && (
                  <div className="space-y-5">
                    {/* Recap */}
                    <div className="px-4 py-3 text-sm" style={{ background: '#f8f5f2', borderRadius: '8px' }}>
                      <div className="flex justify-between items-center">
                        <span style={{ color: 'var(--color-muted)', ...arabicFont }}>{ar ? 'المجموع' : 'Total à payer'}</span>
